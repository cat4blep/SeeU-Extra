...
Install SeeU 0.9.0 or newer and SeeU Extra on the server and every client. Downloads are available on the [releases page](https://github.com/cat4blep/SeeU-Extra/releases).
...
SeeU Extra 0.1.0 for Minecraft 1.21.1 is released under the MIT License.
